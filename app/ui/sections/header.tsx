...
export default function header() {
    return (
        <div className={`${Source_Sans_700.className} flex flex-col w-screen h-screen`}>
            <div className="flex justify-center items-center w-full h-14 bg-fill-light border-b-8 border-primary-dark">
                <Image 
                    ...
                    alt={"icon image"}
                />
                <span className={`text-special text-xl ml-2`}>Food</span>
                <span className={`text-primary-normal text-xl`}>wagon</span>
            </div>

            <div className="flex flex-1 flex-row w-full px-20 bg-gradient-to-b from-primary-normal to-primary-dark">
                ...
                <div className="flex flex-1 justify-center items-end h-full overflow-hidden">
                    <Image 
